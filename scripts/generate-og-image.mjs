...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  <defs>
    ...
    <radialGradient id="glow" cx="50%" cy="42%" r="45%">
      <stop offset="0%" style="stop-color:#1d4ed8;stop-opacity:0.35"/>
  ...
  <rect x="0" y="618" width="1200" height="12" fill="#1d4ed8" opacity="0.6"/>
  ...
  <rect x="330" y="360" width="540" height="34" rx="17" fill="#1d4ed8" opacity="0.18"/>
  <text x="600" y="383" font-family="system-ui,-apple-system,'Segoe UI',sans-serif" font-size="15" font-weight="600" letter-spacing="2" fill="#93c5fd" text-anchor="middle">CONSTRUCTION &#183; ENGINEERING &#183; PLANT HIRE &#183; SECURITY</text>
